...
// Uploads files
if (isset($_POST['answerKeyUpload'])) { // if save button on the form is clicked

    // Data get from form
    $userID = $_REQUEST['idOffFile'];
    ...
    if (!in_array($extension, ['zip', 'pdf', 'docx'])) {
        ...
        if (move_uploaded_file($file, $destination)) {
            ...
            // $sql = "INSERT INTO answerkey (filename, size, download,userID) VALUES ('$filename', $size, 0,'$userID')";

            $sql = "UPDATE files SET answerFile='$filename', asnswerFileSize = '$size', answerDownload='0', AnsweruploadDate = '$current_date' WHERE id=$userID";
