...
<body>
    ...
    <div class="home_content">
        <div class="trackBox">
            ...
            $dataFromfile = "SELECT * from files";
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><form action="adminDashboard.php" method="POST" enctype="multipart/form-data">
                                    <input type="text" value="<?php echo $res['id'] ?>" name="idOffFile" hidden>
                                    <input type="file" name="myfile">upload
                                    <input type="submit" name="answerKeyUpload">
                                </form></td>
