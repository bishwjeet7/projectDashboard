    ...
    <div class="home_content">
        <div class="trackBox">
            ...
            <div class="table-container">
                <H1 class="heading">Track Project <table></table>
                </H1>
                <table class="table">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td data-label="Submission Date"><?php echo $res['submissionDate'] ?></td>
                                <td data-label="Status"><?php echo $res['projectstatus'] ?></td>
                                <td data-label="Message"><span class="text_open"><?php echo $res['projectMessage'] ?></span></td>
                                <td data-label="Assigned Teacher"><?php echo $res['assignedTeacher'] ?></td>
                                <td data-label="any Query"><a href="#" class="btn">Query</a></td>
                            </tr>
                        <?php
                        }
                        ?>
